package com.clauvaneandroid.wallpapercdz.menu;
...
import com.clauvaneandroid.wallpapercdz.R;
import com.clauvaneandroid.wallpapercdz.contato.Contato;
import com.clauvaneandroid.wallpapercdz.puzzle.ListarPuzzles;
import com.clauvaneandroid.wallpapercdz.util.Conexao;
import com.clauvaneandroid.wallpapercdz.wallpaper.ListarWallpapers;
...
//		}
		...
		if(visitas % 30 == 15){
			...
			alerta.setMessage("Hi Knights of the Zodiac lover! Do you like this app? Please help grow up our Fan Club!");
			// M�todo executado se escolher Sim
			alerta.setPositiveButton("Share", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
					String msg = "I love Knights of the Zodiac! If you love Knights of the Zodiac too, join our Knights of Zodiac Fan Club on Android! \n https://play.google.com/store/apps/details?id=com.clauvaneandroid.wallpapercdz";
			...
			alerta.setNegativeButton("Rate", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
					Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=com.clauvaneandroid.wallpapercdz");
