package com.clauvaneandroid.wallpapercdz.wallpaper;
...
import com.clauvaneandroid.wallpapercdz.util.BitmapResized;
...
//		titulo.setTypeface(font); 
		...
		share.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				sendIntent.putExtra(Intent.EXTRA_SUBJECT, "I love Knights of the Zodiac!");
				//Full Path to the attachment
				sendIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse("android.resource://com.clauvaneandroid.wallpapercdz/" + wallpapers[posicao]));
